...
export const VOCAB_WORD_DATA = [
  ...
  { id: 'wt1-11', vi: 'Cay', jp: '辛い', en: 'Spicy', type: 'word' as const, stage: 2 },
  { id: 'wt1-12', vi: 'Ngon', jp: '美味しい', en: 'Delicious', type: 'word' as const, stage: 2 },
  { id: 'wt1-13', vi: 'Dở tệ', jp: 'まずい', en: 'Awful / Bad tasting', type: 'word' as const, stage: 2 },
  { id: 'wt1-14', vi: 'Món ăn', jp: '料理', en: 'Dish / Food', type: 'word' as const, stage: 2 },
  { id: 'wt1-15', vi: 'Ăn', jp: '食べる', en: 'Eat', type: 'word' as const, stage: 2 },
  { id: 'wt1-16', vi: 'Uống', jp: '飲む', en: 'Drink', type: 'word' as const, stage: 2 },
  { id: 'wt1-17', vi: 'Tiền', jp: 'お金', en: 'Money', type: 'word' as const, stage: 2 },
  { id: 'wt1-18', vi: 'Xe máy', jp: 'バイク', en: 'Motorbike', type: 'word' as const, stage: 2 },
  { id: 'wt1-19', vi: 'Đi', jp: '行く', en: 'Go', type: 'word' as const, stage: 2 },
  { id: 'wt1-20', vi: 'Ngủ', jp: '寝る', en: 'Sleep', type: 'word' as const, stage: 2 },
  { id: 'wt2-1', vi: 'Xịn xò', jp: '超いい', en: 'Awesome / Fancy', type: 'word' as const, stage: 3 },
  { id: 'wt2-2', vi: 'Kệ', jp: 'まあいい', en: 'Whatever / Let it be', type: 'word' as const, stage: 3 },
  { id: 'wt2-3', vi: 'Toang', jp: '詰んだ', en: 'Ruined / Done for', type: 'word' as const, stage: 3 },
  { id: 'wt2-4', vi: 'Mượt', jp: 'スムーズ', en: 'Smooth', type: 'word' as const, stage: 3 },
  { id: 'wt2-5', vi: 'Đỉnh', jp: '最高', en: 'Peak / Awesome', type: 'word' as const, stage: 3 },
  { id: 'wt2-6', vi: 'Dễ thương', jp: 'かわいい', en: 'Cute', type: 'word' as const, stage: 3 },
  { id: 'wt2-7', vi: 'Thời tiết', jp: '天気', en: 'Weather', type: 'word' as const, stage: 3 },
  { id: 'wt2-8', vi: 'Ví', jp: '財布', en: 'Wallet', type: 'word' as const, stage: 3 },
  { id: 'wt2-9', vi: 'Tắc đường', jp: '渋滞', en: 'Traffic jam', type: 'word' as const, stage: 3 },
  { id: 'wt2-10', vi: 'Ngầu', jp: 'かっこいい', en: 'Cool', type: 'word' as const, stage: 3 },
  { id: 'wt2-11', vi: 'Công ty', jp: '会社', en: 'Company', type: 'word' as const, stage: 4 },
  { id: 'wt2-12', vi: 'Điện thoại', jp: 'スマホ', en: 'Smartphone', type: 'word' as const, stage: 4 },
  { id: 'wt2-13', vi: 'Cà phê', jp: 'コーヒー', en: 'Coffee', type: 'word' as const, stage: 4 },
  { id: 'wt2-14', vi: 'Mưa', jp: '雨', en: 'Rain', type: 'word' as const, stage: 4 },
  { id: 'wt2-15', vi: 'Nắng', jp: '晴れ', en: 'Sunny / Sunshine', type: 'word' as const, stage: 4 },
  { id: 'wt2-16', vi: 'Xe buýt', jp: 'バス', en: 'Bus', type: 'word' as const, stage: 4 },
  { id: 'wt2-17', vi: 'Cảnh sát', jp: '警察', en: 'Police', type: 'word' as const, stage: 4 },
  { id: 'wt2-18', vi: 'Bệnh viện', jp: '病院', en: 'Hospital', type: 'word' as const, stage: 4 },
  { id: 'wt2-19', vi: 'Ghế', jp: '椅子', en: 'Chair', type: 'word' as const, stage: 4 },
  { id: 'wt2-20', vi: 'Trộm', jp: '泥棒', en: 'Thief / Robber', type: 'word' as const, stage: 4 },
];
...
export const VOCAB_PHRASE_DATA = [
  ...
  { id: 'pt1-11', vi: 'Cái này bao tiền?', jp: 'これいくらですか？', en: 'How much is this?', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-12', vi: 'Em ơi, tính tiền nhé', jp: 'お会計お願いします', en: 'Check, please', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-13', vi: 'Đắt quá, bớt chút đi!', jp: '高すぎる、ちょっとまけて!', en: 'Too expensive, give me a discount!', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-14', vi: 'Giúp tôi với', jp: '手伝ってください', en: 'Please help me', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-15', vi: 'Ghê ghê', jp: 'すごいな', en: 'Wow / Amazing', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-16', vi: 'Từ từ đã', jp: 'ちょっと待って', en: 'Wait a moment', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-17', vi: 'Văn Miếu ở đâu?', jp: '文廟はどこですか？', en: 'Where is the Temple of Literature?', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-18', vi: 'Mệt xỉu', jp: '疲れすぎる', en: 'Exhausted', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-19', vi: 'Giật cả mình', jp: 'びっくりした', en: 'I was startled', type: 'phrase' as const, stage: 2 },
  { id: 'pt1-20', vi: 'Không sao đâu', jp: '大丈夫', en: 'It\'s okay / No problem', type: 'phrase' as const, stage: 2 },
  { id: 'pt2-1', vi: 'Bạn ăn cơm chưa?', jp: 'ご飯食べた？', en: 'Have you eaten yet?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-2', vi: 'Dạo này bạn có khỏe không?', jp: '最近元気ですか？', en: 'How have you been lately?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-3', vi: 'Thời tiết hôm nay đẹp nhỉ', jp: '今日は天気いいね', en: 'The weather is nice today, isn\'t it?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-4', vi: 'Tôi đến Việt Nam để làm việc', jp: '仕事でベトナムに来ました', en: 'I came to Vietnam for work', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-5', vi: 'Đói quá, mình đi ăn đi!', jp: 'お腹空いたからご飯行こう!', en: 'I\'m so hungry, let\'s go eat!', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-6', vi: 'Món này có cay không?', jp: 'これ辛いですか?', en: 'Is this dish spicy?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-7', vi: 'Cho tôi một bát phở không rau mùi', jp: 'フォー１杯、パクチー抜きでください', en: 'One bowl of pho without cilantro, please', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-8', vi: 'Tôi làm mất ví rồi', jp: '財布をなくしちゃった', en: 'I lost my wallet', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-9', vi: 'Bạn bao nhiêu tuổi rồi?', jp: '何歳ですか？', en: 'How old are you?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-10', vi: 'Bạn có thể chụp ảnh hộ tôi được không', jp: '写真を撮ってくれませんか', en: 'Could you take a photo for me?', type: 'phrase' as const, stage: 3 },
  { id: 'pt2-11', vi: 'Cái này có nghĩa là gì?', jp: 'これはどういう意味ですか？', en: 'What does this mean?', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-12', vi: 'Tôi mới sang Việt Nam nên chưa quen lắm', jp: 'ベトナムに来たばかりなので、まだあまり慣れていない', en: 'I just arrived in Vietnam so I\'m not used to it yet', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-13', vi: 'Tôi sống ở Việt Nam được một năm rồi', jp: 'ベトナムに住んで1年になります', en: 'I have been living in Vietnam for one year', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-14', vi: 'Nhà vệ sinh ở đâu vậy?', jp: 'トイレはどこですか？', en: 'Where is the restroom?', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-15', vi: 'Cuối tuần bạn rảnh không?', jp: '今週末空いてる？', en: 'Are you free this weekend?', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-16', vi: 'Tôi đang cố nói tiếng Việt, sai thì đừng cười nha', jp: 'ベトナム語を頑張って話してるので、間違っても笑わないでね', en: 'I\'m trying to speak Vietnamese, please don\'t laugh if I make mistakes', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-17', vi: 'Tôi đang cố sống sót qua mùa hè ở Việt Nam', jp: 'ベトナムの夏をなんとか生き延びています', en: 'I\'m trying to survive the summer in Vietnam', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-18', vi: 'Cứ tắc đường kiểu này chắc tôi già đi thêm mấy tuổi', jp: 'この渋滞で何歳か年を取った気がする', en: 'With traffic jams like this, I feel like I\'ve aged a few years', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-19', vi: 'Tôi không lười, chỉ đang tiết kiệm năng lượng thôi', jp: '怠けてるんじゃない、エネルギー節約中です', en: 'I\'m not lazy, I\'m just saving energy', type: 'phrase' as const, stage: 4 },
  { id: 'pt2-20', vi: 'Mua cái này xong chắc phải ăn mì gói cả tuần', jp: 'これ買ったら一週間インスタント麺生活だな', en: 'After buying this, I\'ll probably have to eat instant noodles for a week', type: 'phrase' as const, stage: 4 },
];
